...
ActiveRecord::Schema.define(version: 2020_12_07_221307) do
  ...
  create_table "stores", force: :cascade do |t|
    ...
    t.boolean "open"
    t.index ["distribution_center_id"], name: "index_stores_on_distribution_center_id"
  end

  add_foreign_key "candies", "candy_shops"
  add_foreign_key "stores", "distribution_centers"
end
